...
function writeToRedis(tweet, screen_name){
  return new Promise((resolve, reject) => {
    ...
    if(tweet['entities']['media'] == undefined){
      var hash_set = ['tweet_id', tweet['id'], 'tweet_text', tweet['full_text'], 'avatar', tweet['user']['profile_image_url'], 'screen_name', tweet['user']['screen_name']];
    } else {
      var hash_set = ['tweet_id', tweet['id'], 'tweet_text', tweet['full_text'], 'avatar', tweet['user']['profile_image_url'], 'screen_name', tweet['user']['screen_name'], 'media_url', tweet['media_url']];
    }
